...
public class HomeFastSaleFragment extends SuperBaseFragment<HomeFastSaleBean> implements View.OnClickListener {
    ...
    private void initListener() {
        mFastsaleListviewR1Left.setOnClickListener(this);
        mFastsaleListviewR1Right.setOnClickListener(this);
        mFastsaleListviewR2Left.setOnClickListener(this);
        mFastsaleListviewR2Right.setOnClickListener(this);

        mFastsaleListviewR3Left.setOnClickListener(this);
        mFastsaleListviewR3Right.setOnClickListener(this);
        mFastsaleListviewR4Left.setOnClickListener(this);
        mFastsaleListviewR4Right.setOnClickListener(this);
    }
