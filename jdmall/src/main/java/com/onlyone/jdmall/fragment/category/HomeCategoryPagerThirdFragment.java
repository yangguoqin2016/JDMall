 ...
 * @描述: ${TODO}
 */
public class HomeCategoryPagerThirdFragment extends BaseFragment<ItemBean> {
    ...
    protected void refreshSuccessView(ItemBean data) {
        mCategoryCommonPagerTv.setText("宝宝用品");

        //从分类的根页面获取到数据
        mListDatas = HomeCategoryFragment.mThirdList;
    ...
    protected void handleError(Exception e) {
        Toast.makeText(getContext(), "分类第三个页面出错", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onResume() {
        ...
        mTopBarView.findViewById(R.id.hot_product_topbar_back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.remove(HomeCategoryPagerThirdFragment.this);
                transaction.commit();
