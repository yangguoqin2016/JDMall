package com.onlyone.jdmall.manager;
...
/**
 * copy from: http://www.cnblogs.com/tianzhijiexian/p/4469516.html
 *
 * @项目名: JDMall
 * @包名: com.onlyone.jdmall.manager
 * @创建者: wt
 * @创建时间: 2016/3/8 23:33
 * @描述: ${TODO}
 */
...
//
//        int rowCount = getRowCountForAccessibility(recycler, state);
//
...
//        final int widthMode = View.MeasureSpec.getMode(widthSpec);
        ...
        int itemWidth = (int) (widthSize * 1f / span + 0.5f);
        int[] heights = new int[span];

        for (int i = 0; i < count; i++) {
//            View view = getChildAt(i);
            View view = recycler.getViewForPosition(i);
            view.measure(View.MeasureSpec.makeMeasureSpec(itemWidth, View.MeasureSpec.EXACTLY), 0);
            int itemHeight = view.getMeasuredHeight();

            heights[i % span] += itemHeight;
        }
        ...
        LogUtil.d("tt","width: " + widthSize);
        LogUtil.d("tt","height: " + heigh);
